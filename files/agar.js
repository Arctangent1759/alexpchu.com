(function(g,m) {
  ...
  function Xa() {
    if(.4>k)O=null;
      ...
      for(var a=Number.POSITIVE_INFINITY,b=Number.POSITIVE_INFINITY,c=Number.NEGATIVE_INFINITY,d=Number.NEGATIVE_INFINITY,e=0,l=0;
          l<v.length;
          l++) {
            var h=v[l];
      ...
      O=Ya.ca( {
        X:a-(e+100),Y:b-(e+100),fa:c+(e+100),ga:d+(e+100),da:2,ea:4
      }
      );
      for(l=0;
          l<v.length;
          l++)if(h=v[l],h.I()&&!(20>=h.size*k))for(a=0;
            a<h.a.length;
            ++a)b=h.a[a].x,c=h.a[a].y,b<t-q/2/k||c<u-r/2/k||b>t+q/2/k||c>u+r/2/k||O.i(h.a[a])
    }
  }
  function ra() {
    Z=(V-q/2)/k+t;
  ...
  function Ca() {
    null==aa&&(aa= {
    },m("#region").children().each(function() {
  ...
  function Ka() {
    ...
    m.ajax(ba+"//m.agar.io/", {
      error:function() {
        ...
        a[2]&&alert(a[2]);
        La("ws://"+a[0],a[1])
      },dataType:"text",method:"POST",cache:!1,crossDomain:!0,data:(w+Q||"?")+"\n154669603"
    }
    )
  }
  function Y() {
  ...
  function La(a,b) {
    ...
    s.onopen=function() {
      ...
      for(var c=0;
          c<b.length;
          ++c)a.setUint8(c+1,b.charCodeAt(c));
      L(a);
      Ma()
    };
    s.onmessage=ab;
  ...
  function cb(a) {
    ...
    switch(a.getUint8(c++)) {
      ...
      case 20:p=[];
              G=[];
              break;
      case 21:ua=a.getInt16(c,!0);
              c+=2;
              va=a.getInt16(c,!0);
              c+=2;
              wa||(wa=!0,fa=ua,ga=va);
              break;
      case 32:G.push(a.getUint32(c,!0));
              c+=4;
              break;
      case 49:if(null!=y)break;
      ...
      case 50:y=[];
              ...
              for(e=0;
                  e<d;
                  ++e)y.push(a.getFloat32(c,!0)),c+=4;
              Na();
              break;
      case 64:ha=a.getFloat64(c,!0),c+=8,ia=a.getFloat64(c,!0),c+=8,ja=a.getFloat64(c,!0),c+=8,ka=a.getFloat64(c,!0),c+=8,R=(ja+ha)/2,S=(ka+ia)/2,T=1,0==p.length&&(t=R,u=S,k=T)
    }
  }
  function db(a,b) {
    H=+new Date;
    ...
    for(e=0;
        ;) {
          ...
          f=a.getInt16(b,!0);
          b+=2;
          for(var g=a.getUint8(b++),k=a.getUint8(b++),q=a.getUint8(b++),g=(g<<16|k<<8|q).toString(16);
              6>g.length;
             )g="0"+g;
    ...
    for(e=0;
        e<c;
        e++)d=a.getUint32(b,!0),b+=4,n=A[d],null!=n&&n.S();
    xa&&0==p.length&&Fa(!1)
  }
  function N() {
    var a;
  ...
  function Ma() {
    if(ya()&&null!=F) {
      ...
      for(var b=0;
          b<F.length;
          ++b)a.setUint16(1+2*b,F.charCodeAt(b),!0);
      L(a)
    }
  }
  function ya() {
  ...
  function sa() {
    ...
    if(0<p.length) {
      ...
      for(var c=a=0,d=0;
          d<p.length;
          d++)p[d].K(),a+=p[d].x/p.length,c+=p[d].y/p.length;
      R=a;
      S=c;
      T=k;
      t=(t+a)/2;
    ...
    if(wa) {
      ...
      for(d=0;
          d<p.length;
          d++)f.moveTo(p[d].x,p[d].y),f.lineTo(fa,ga);
      f.stroke();
      f.restore()
    }
    f.restore();
  ...
  function gb() {
    ...
    f.globalAlpha=.2;
    f.scale(k,k);
    for(var a=q/k,b=r/k,c=-.5+(-t+a/2)%50;
        c<a;
        c+=50)f.beginPath(),f.moveTo(c,0),f.lineTo(c,b),f.stroke();
    for(c=-.5+(-u+b/2)%50;
        c<b;
        c+=50)f.beginPath(),f.moveTo(0,c),f.lineTo(a,c),f.stroke();
    f.restore()
  }
  function ib() {
    if(Da&&Aa.width) {
  ...
  function Na() {
    x=null;
    if(null!=y||0!=B.length)if(null!=y||oa) {
      x=document.createElement("canvas");
      var a=x.getContext("2d"),b=60,b=null==y?b+24*B.length:b+180,c=Math.min(200,.3*q)/200;
      x.width=200*c;
      x.height=b*c;
      a.scale(c,c);
      a.globalAlpha=.4;
      ...
      if(null==y)for(a.font="20px Ubuntu",b=0;
          b<B.length;
          ++b)c=B[b].name||"An unnamed cell",oa||(c="An unnamed cell"),-1!=G.indexOf(B[b].id)?(p[0].name&&(c=p[0].name),a.fillStyle="#FFAAAA"):a.fillStyle="#FFFFFF",c=b+1+". "+c,a.fillText(c,100-a.measureText(c).width/2,70+24*b);
      else for(b=c=0;
          b<y.length;
          ++b) {
  ...
  var ba=g.location.protocol,$a="https:"==ba;
  if(g.location.ancestorOrigins&&g.location.ancestorOrigins.length&&"https://apps.facebook.com"!=g.location.ancestorOrigins[0])
    ...
    var qa,f,C,q,r,O=null,s=null,t=0,u=0,G=[],p=[],A= {
    },v=[],I=[],B=[],V=0,W=0,Z=-1,$=-1,fb=0,H=0,F=null,ha=0,ia=0,ja=1E4,ka=1E4,k=1,w=null,Sa=!0,oa=!0,Ba=!1,xa=!1,J=0,la=!1,Ta=!1,R=t=~~((ha+ja)/2),S=u=~~((ia+ka)/2),T=1,Q="",y=null,pa=!1,wa=!1,ua=0,va=0,fa=0,ga=0,P=0,jb=["#333333","#FF3333","#33FF33","#3333FF"],za=!1,ta=!1,E=1,Da="ontouchstart"in g&&/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),Aa=new Image;
    ...
    if("undefined"==typeof console||"undefined"==typeof DataView||"undefined"==typeof WebSocket||null==Ua||null==Ua.getContext||null==g.localStorage)alert("You browser does not support this game, we recommend you to use Firefox to play this");
      ...
      "),kb=["8","nasa"],lb=["m'blob"];
      Oa.prototype= {
        id:0,a:null,l:null,name:null,k:null,J:null,x:0,y:0,size:0,p:0,q:0,o:0,D:0,F:0,n:0,W:0,L:0,ja:0,ba:0,A:!1,d:!1,j:!1,M:!0,S:function() {
          var a;
          for(a=0;
              a<v.length;
              a++)if(v[a]==this) {
          ...
          0==this.a.length&&0<a&&(this.a.push( {
            Q:this,e:this.size,x:this.x,y:this.y
          }
          ...
          this.R();
          for(var a=this.a,b=this.l,c=a.length,d=0;
              d<c;
              ++d) {
          ...
          for(var h=this,g=this.d?0:(this.id/1E3+H/1E4)%(2*Math.PI),d=0;
              d<c;
              ++d) {
          ...
          if(this.I()) {
            ...
            5>this.C()&&(b=!0);
            if(this.M&&!b)for(var c=0;
                c<this.a.length;
                c++)this.a[c].e=this.size;
            this.M=b;
            a.save();
            this.ba=H;
            c=this.K();
            ...
            if(0!=this.id) {
              ...
              Ta&&(c||0==p.length&&(!this.d||this.j)&&20<this.size)&&(null==this.J&&(this.J=new na(this.h()/2,"#FFFFFF",!0,"#000000")),c=this.J,c.H(this.h()/2),c.u(~~(this.size*this.size/100)),d=Math.ceil(10*k)/10,c.$(d),e=c.G(),l=~~(e.width/d),h=~~(e.height/d),a.drawImage(e,~~this.x-~~(l/2),b-~~(h/2),l,h))
            }
            a.restore()
          }
        }
      ...
      na.prototype= {
        w:"",N:"#000000",P:!1,s:"#000000",r:16,m:null,O:null,g:!1,v:1,H:function(a) {
      ...
      var Ya= {
        ca:function(a) {
          ...
          b.prototype= {
            x:0,y:0,f:0,c:0,depth:0,items:null,b:null,B:function(a) {
              for(var b=0;
                  b<this.items.length;
                  ++b) {
                    var c=this.items[b];
          ...
          return {
            root:new b(a.X,a.Y,a.fa-a.X,a.ga-a.Y,0),i:function(a) {
              this.root.i(a)
            },t:function(a,b) {
              this.root.t(a,b)
